...
private:
  //std::map<::rl::math::Vector,double> cons_viol_freq;
  //void update_tree_cvf(Tree& tree, const Neighbor& nearest);
  RrtConConBase::Neighbor nearest_nonexh(const Tree& tree, const ::rl::math::Vector& chosen);
};
